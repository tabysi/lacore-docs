...
export const scripts = [
  {
    ...
    color: '#f59e0b',
    logo: '',               // e.g. '/logos/vms_housing.png'
  ...
  },
  {
    ...
    icon: '🪪',
    color: '#6d28d9',
    logo: '',               // e.g. '/logos/vms_identity.png'
  ...
  },
  {
    ...
    icon: '👥',
    color: '#0ea5e9',
    logo: '',               // e.g. '/logos/vms_multichars.png'
