...
export const scripts = [
  {
    ...
    color: '#ef4444',
    logo: '',
    desc: "LACORE's automatic calls (911 / Panic / Shots / Crime Broadcast / …) forward into your dispatch out of the box: tk_dispatch, ps-dispatch, cd_dispatch, core_dispatch, rcore_dispatch, linden_outlawalert. Pick one (or 'auto') and set one neutral call map in cfg-integrations-sh.lua.",
  },
  {
    name: 'vms_housing',
    via: 'Native export',
  ...
  },
  {
    ...
    color: '#f59e0b',
    logo: '',
    desc: 'LACORE features become inventory items — a phone, an MDT tablet per department, an ID card. Also works with qb-inventory and ESX.',
  },
  {
    name: 'ox_target',
    via: 'Third-Eye',
  ...
  },
  {
    ...
    color: '#eab308',
    logo: '',
    desc: 'Route LACORE notifications to ox_lib, okokNotify or mythic_notify with one setting (NotifyCfg.mode), the framework notify (ESX / QBCore), or any other resource via a custom handler — cfg-notify-sh.lua.',
  },
  {
