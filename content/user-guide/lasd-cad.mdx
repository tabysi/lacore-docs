...
| **CLASSIC PCMS** | The original amber-on-black terminal with the coloured function rail — unchanged. |
...
Press **NEW MESSAGE**, type **MAP** and press Enter. The Message Detail / Default window turns into a
live map:
...
- clicking an incident opens its incident record. **CLEAR DEF WINDOW** closes the map.

The map is part of the MDC skin; the classic PCMS skin does not have it.
