...
- ✅ **Talk on the radio** (your pma-voice push-to-talk key) — the radio binding fires even with the MDT focused
...
| **Attachment** | Department **Bulletin Board** — everyone on duty can pin notes |
...
- **"The mouse keeps turning the camera" / "I clicked and shot my gun"** — camera-look and attack
  controls are blocked while the MDT is open; if they aren't on your server, the resource build is
  outdated.
...
- **"Unread MDT Calls banner won't go away"** — the banner clears when you open the MDT.
