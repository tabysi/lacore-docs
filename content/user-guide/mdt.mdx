...
The MDT (Mobile Data Terminal) is the in-car CAD for **Law Enforcement**, **Fire/EMS**, and **Coroner** units. It's modeled after the real **PremierOne™ Mobile Client** used in LAPD vehicles, and is the central hub for working incidents, running queries, managing your status, and talking to dispatch.
...
```
┌────────────────────────────────────────────────────────────────┐
│  PremierOne™ Mobile Client                            ⚙ ⊙ – ▢ ✕│  ← Title bar (drag to move)
├────────────────────────────────────────────────────────────────┤
