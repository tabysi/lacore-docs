...
- Every run is announced in the in-game chat to on-duty units (`MDT` prefix, blue). Server owners can turn this off with `MdtConfig.announceRuns = false` in `configs/cfg-mdt-sh.lua` (LASD/CAD runs included)
