...
3. Choose the report type: **Citation** (ticket / fine), **Arrest** (booking + jail time) or
   **Warning** (documented, but costs nothing).
...
```
┌──────────────────────────────────────────────┐
│ [Citation] [Arrest] [Warning]  [Search… ]     │
│ ──────────────────────────────────────────── │
...
A **warning** records the stop and the charges you *would* have filed, and imposes nothing: no fine,
no jail, no booking. It lands on the subject's record like a citation does, so the next officer to
run them can see they have already been spoken to about it.

It is also counted — see [My Activity](/user-guide/officer-stats). Before this existed, letting
someone off with a warning left either nothing behind or a free-text note that no statistic could
count, which made a lenient officer look like an inactive one.
...
│    🟥 F   F7    Murder (187)                $10000 · 60 mo   ✓ │
│    🟨 M   M5    Petty Theft                 $500 · 1 mo        │
│    🟨 M   M1    Disturbing the Peace        $250               │
│ ────────────────────────────────────────────────────────────── │
│ [ Notes (optional) ]        Selected: 1 · $10000 · 60 mo       │
│                                                     [ Issue ]  │
└────────────────────────────────────────────────────────────────┘
```
